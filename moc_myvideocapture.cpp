...
#include <memory>
#include "../../untitled/myvideocapture.h"
...
QT_MOC_LITERAL(1, 15, 17), // "newPixmapCaptured"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "MyVideoCapture\0newPixmapCaptured\0"
};
...
void MyVideoCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyVideoCapture::newPixmapCaptured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyVideoCapture::newPixmapCaptured()
{
